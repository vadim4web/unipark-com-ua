...
<template>
  <main>
    ...
    >
      ...
      <a
        href="https://tickets.svitveletniv.com/event/TVrBW3WWx4QfPHVuTd74nk-0CvAx_p64LHRK"
        target="_blank"
        rel="button"
      ...
      <div class="left flex flex-col gap-[1.25rem]">
        <div class="term flex flex-col gap-[0.5rem]">
          ...
          <div class="social-media flex justify-start items-center gap-[1rem]">
            <a
              href="https://www.youtube.com/@svitveletniv"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/svitveletniv/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/svit_veletniv/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
    ...
    <section class="video-gallery">
      ...
      <div class="videos grid grid-cols-2 gap-[1.25rem]">
        <div class="video video1">
          <iframe
            src="https://www.youtube.com/embed/vbmq5HyVsg4?si=OwswSOYdt1i6rGyx"
    ...
    <section class="press">
      ...
      >
        <div class="source">
          <h4 class="src text-pro-bold text-[3.5rem]">
            {{ $t('giants_world_press_2_src') }}
          </h4>
          <p class="date text-pro-bold text-[2rem]">09.10.21</p>
        </div>
        <div class="description flex flex-col gap-[0.75rem]">
          <h4 class="title text-bold text-[1.25rem] leading-[133%] uppercase">
            {{ $t('giants_world_press_2') }}
          </h4>
      ...
      >
        <div class="source">
          <h4 class="src text-pro-bold text-[3.5rem]">
            {{ $t('giants_world_press_3_src') }}
          </h4>
          <p class="date text-pro-bold text-[2rem]">26.08.21</p>
        </div>
        <div class="description flex flex-col gap-[0.75rem]">
          <h4 class="title text-bold text-[1.25rem] leading-[133%] uppercase">
            {{ $t('giants_world_press_3') }}
          </h4>
...
.gallery {
  ...
  .photo1 {
    background-image: url('../assets/img/G_W_1.jpg');
  }
  .photo2 {
    background-image: url('../assets/img/G_W_2.jpg');
  }
  .photo3 {
    background-image: url('../assets/img/G_W_3.jpg');
  }
}
